...
namespace Snake
{
    ...
    public class AStarPathfinder
    {
        ...
        public int temp_x_zmija;
        public int temp_y_zmija;
        ...
        // za 60 x 34
        readonly int kPreallocatedNodes = 25000;
        readonly int kPreallocatedMapSearchNodes = 10000;
        ...
        public MapSearchNode AllocateMapSearchNode(NodePosition nodePosition)
        {
            ...
            {
                return mapSearchNodePool[temp_x_zmija * temp_y_zmija];
            }
        }
